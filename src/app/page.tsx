...
function Navigation() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-[100px] flex items-center justify-between px-6 lg:px-12 mix-blend-nav">
      <div className="font-clash font-bold text-2xl tracking-tighter">
        LittleTho
      </div>
      <div className="hidden md:flex items-center gap-8">
        <a href="#work" className="text-sm uppercase tracking-[0.2em] font-bold hover:opacity-60 transition-opacity">Work</a>
        <a href="#about" className="text-sm uppercase tracking-[0.2em] font-bold hover:opacity-60 transition-opacity">About</a>
        <a href="#projects" className="text-sm uppercase tracking-[0.2em] font-bold hover:opacity-60 transition-opacity">Projects</a>
        <a 
          href="#contact" 
          className="text-sm uppercase tracking-[0.2em] font-bold border border-white/20 px-6 py-2 rounded-full hover:bg-white hover:text-black transition-all duration-300"
        >
          Contact
        </a>
      </div>
...
function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Light leaks */}
      <div className="light-leak-orange w-[600px] h-[600px] -top-[200px] -right-[200px]" />
      <div className="light-leak-blue w-[500px] h-[500px] -bottom-[150px] -left-[150px]" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 relative">
            <RevealUp delay={0.2}>
              <h1 className="font-clash font-bold text-[12vw] lg:text-[8vw] leading-none tracking-tighter uppercase">
                Game
              </h1>
            </RevealUp>
            
            <RevealUp delay={0.3}>
              <h1 className="font-clash font-bold text-[12vw] lg:text-[8vw] leading-none tracking-tighter uppercase -mt-4">
                Developer
              </h1>
            </RevealUp>
          ...
          {stats.map((stat, i) => (
            <RevealUp key={stat.label} delay={i * 0.1}>
              <div className="text-center lg:text-left">
                ...
                <p className="font-clash font-medium text-3xl lg:text-4xl">
                  {stat.value}
                </p>
              </div>
            </RevealUp>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-3">
            <RevealUp>
              <span className="font-clash font-bold text-6xl lg:text-8xl tracking-tighter text-white/20">
                01
              </span>
            </RevealUp>
          </div>
          ...
          <div className="lg:col-span-9">
            <RevealUp delay={0.1}>
              <h2 className="font-clash font-bold text-4xl lg:text-6xl tracking-tighter mb-8">
                About
              </h2>
            </RevealUp>
...
003e
            ...
            <RevealUp delay={0.4}>
              <a 
                href="#work" 
                className="inline-flex items-center gap-2 mt-8 text-sm uppercase tracking-[0.2em] font-bold border-b border-white pb-1 hover:pb-2 transition-all"
              >
  ...
  const projects = [
    {
      ...
      year: "2024",
      image: "https://images.unsplash.com/photo-1614294149010-950b698f72c0?w=800&auto=format&fit=crop",
    },
    {
    ...
    <section id="projects" className="py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 mb-20">
          ...
          <div className="lg:col-span-9">
            <RevealUp delay={0.1}>
              <h2 className="font-clash font-bold text-4xl lg:text-6xl tracking-tighter">
                Featured Projects
              </h2>
            </RevealUp>
          </div>
          ...
          {projects.map((project, i) => (
            <RevealUp key={project.title} delay={i * 0.15}>
              <div className="group cursor-pointer">
                <div className="relative aspect-[4/3] overflow-hidden rounded-sharp mb-4">
                  <img 
                    src={project.image}
                    alt={project.title}
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                    <span className="text-sm uppercase tracking-[0.2em] font-bold">View Project <ArrowUpRight className="w-4 h-4 inline" /></span>
                  </div>
                </div>                
                <div className="flex items-center justify-between">
                  <h3 className="font-clash font-medium text-xl">{project.title}</h3>
    ...
    <section id="work" className="py-32 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-9">
            <RevealUp delay={0.1}>
              <h2 className="font-clash font-bold text-4xl lg:text-6xl tracking-tighter mb-12">
                Skills & Expertise
              </h2>
            </RevealUp>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {skills.map((skill, i) => (
                <RevealUp key={skill.name} delay={0.2 + i * 0.1}>
                  <div className="text-center p-8 border border-white/5 rounded-sharp hover:border-white/20 transition-colors">
...
function FooterSection() {
  return (
    <footer id="contact" className="relative py-32 bg-midnight-secondary overflow-hidden">
      {/* Light leak */}
      <div className="light-leak-orange w-[400px] h-[400px] -bottom-[200px] left-1/2 -translate-x-1/2" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 text-center">
        <RevealUp>
          <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/40 mb-8">
            Get in Touch
          </p>
        </RevealUp>        
        <RevealUp delay={0.1}>
          <a 
            href="mailto:hello@littletho.dev"
            className="inline-block font-clash font-bold text-4xl lg:text-6xl tracking-tighter border-b border-white pb-2 hover:pb-4 hover:opacity-60 transition-all duration-300"
          >
            hello@littletho.dev
          </a>
        </RevealUp>        
        ...
        <RevealUp delay={0.3}>
          <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/20 mt-16">
            © 2024 LittleTho. All rights reserved.
          </p>
        </RevealUp>
      </div>
    </footer>
